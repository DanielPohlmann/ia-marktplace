---
name: legal-ai-regulation
description: Use when identifying AI-specific regulations and compliance requirements that apply to AI/ML-powered software products. Covers the EU AI Act, US AI executive orders, China's AI regulations, and emerging global frameworks with risk classification and compliance obligations. USE FOR: EU AI Act, AI regulation, AI risk classification, AI transparency, AI liability, algorithmic accountability, AI ethics compliance, US AI executive orders, China AI rules, AI auditing requirements DO NOT USE FOR: AI security vulnerabilities and prompt injection (use security-ai-security), ML model development best practices, responsible AI ethics without legal dimension (use security-ai-security), general legal topic routing (use legal)
---
