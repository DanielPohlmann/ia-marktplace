...
description: Use when identifying intellectual property considerations for software products. Covers patents, copyrights, trademarks, trade secrets, and IP assignment with jurisdiction-specific considerations for software companies. USE FOR: software patents, copyright, trademarks, trade secrets, IP ownership, IP assignment, work-for-hire, patent trolls, IP due diligence, prior art, DMCA takedowns DO NOT USE FOR: open-source license selection and compatibility (use legal-open-source-licensing), content moderation and platform liability (use legal-content-moderation), employee IP assignment and contractor classification (use legal-employment-labor), drafting patent applications (consult a patent attorney)
---
