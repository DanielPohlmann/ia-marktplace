---
name: legal-cybersecurity-compliance
description: Use when identifying cybersecurity-specific regulations and incident reporting obligations. Covers NIS2, DORA, SEC cyber disclosure rules, CISA incident reporting, state breach notification laws, cyber insurance requirements, and security certification frameworks (SOC 2, ISO 27001, FedRAMP, CMMC). USE FOR: NIS2, DORA, SEC cybersecurity rules, CISA, breach notification, incident reporting, SOC 2, ISO 27001, cyber insurance, FedRAMP, StateRAMP, CMMC, data breach response DO NOT USE FOR: implementing security controls (use security, security-owasp, or security-secure-sdlc), security testing tools (use security-security-testing), general data privacy law (use legal-privacy-data-protection), financial ICT risk under DORA (use legal-financial-regulation)
---
...
- [NIS2 Directive Official Text (EUR-Lex)](https://eur-lex.europa.eu/eli/dir/2022/2555/oj)
