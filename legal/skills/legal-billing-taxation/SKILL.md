---
name: legal-billing-taxation
description: Use when identifying tax, billing, and revenue-recognition obligations for software sold globally — including Brazilian SaaS (NF-e e-invoicing, ISS, Simples Nacional, Receita Federal). Covers service classification and billing codes, VAT/GST/sales tax, invoicing, revenue recognition (ASC 606/IFRS 15), cloud credits and stored-value, and money-transmission risk for prepaid systems. USE FOR: sales tax, VAT, GST, NF-e, ISS, Brazilian e-invoicing, billing codes, service classification, invoicing, revenue recognition, ASC 606, IFRS 15, cloud credits, stored/prepaid value, tax nexus, digital services tax, withholding tax. DO NOT USE FOR: payment processing and PCI-DSS (use legal-financial-regulation), refund policies and dark patterns (use legal-consumer-protection), pricing terms and SLA (use legal-contracts), tax return prep (consult a tax advisor), general legal routing (use legal)
---
...
- [FASB ASC 606 Revenue Recognition](https://asc.fasb.org/606)
