...
description: Use when identifying contractual considerations for software companies — SLAs, DPAs, MSAs, licensing agreements, and liability allocation. Covers key contract types, essential clauses, jurisdiction-specific requirements, and negotiation considerations for software products and services. USE FOR: SLA, DPA, MSA, software licensing, liability limitation, indemnification, warranty, contract negotiation, jurisdiction clauses, force majeure, escrow agreements, SaaS agreements DO NOT USE FOR: drafting actual contracts (consult legal counsel), open-source license selection (use legal-open-source-licensing), consumer terms of service (use legal-consumer-protection), IP ownership disputes (use legal-intellectual-property), financial regulation compliance (use legal-financial-regulation)
---
...
- [Uniform Commercial Code (UCC) — Cornell Law Institute](https://www.law.cornell.edu/ucc)
- [GDPR Data Processing Agreement Requirements (Article 28)](https://gdpr-info.eu/art-28-gdpr/)
