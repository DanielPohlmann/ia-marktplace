...
description: Use when identifying data privacy and protection laws that apply to LinkDaily or any software product handling PII. Covers GDPR, CCPA/CPRA, LGPD (Brazil — primary jurisdiction for LinkDaily), PIPL, PIPA, DPDPA, PIPEDA, and other global regulations with jurisdiction mapping, key obligations, and compliance triggers. USE FOR: LGPD/GDPR/CCPA compliance, data subject rights, consent management, cross-border data transfers, DPO requirements, breach notification, privacy impact assessments, records of processing DO NOT USE FOR: encryption and key management implementation (use security-cryptography), data masking and PII storage patterns (use security-data-protection), specific DPA contract drafting (consult legal counsel), cybersecurity framework compliance (use legal-cybersecurity-compliance)
---
...
- [GDPR Full Regulation Text (EUR-Lex)](https://eur-lex.europa.eu/eli/reg/2016/679/oj)
