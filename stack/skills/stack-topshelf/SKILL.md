...
- [Topshelf Documentation](https://topshelf.readthedocs.io/en/latest/)
- [Topshelf GitHub Repository](https://github.com/Topshelf/Topshelf)
- [Topshelf NuGet Package](https://www.nuget.org/packages/Topshelf)
