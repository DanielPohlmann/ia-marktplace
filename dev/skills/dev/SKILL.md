---
name: dev
description: Use when working with fundamental software development knowledge — patterns, algorithms, architecture, and craftsmanship principles drawn from canonical published works. Covers the full stack of decisions in LinkDaily's modular-monolith + EDA/DDD/CQRS approach. USE FOR: development fundamentals, pattern selection, architecture decisions, algorithm choice, code quality principles, choosing between architectural styles DO NOT USE FOR: specific algorithm implementations (use dev-algorithms and sub-skills), specific architecture styles (use dev-architecture and sub-skills), specific design patterns (use dev-design-patterns and sub-skills), integration messaging (use dev-integration-patterns and sub-skills), craftsmanship rules (use dev-craftsmanship and sub-skills), frontend specifics (use dev-frontend and sub-skills), backend specifics (use dev-backend and sub-skills)
---
