---
name: dev-architecture-hexagonal
description: Hexagonal Architecture (Ports and Adapters), Onion Architecture, and their relationship to Clean Architecture -- enabling technology-independent domain logic with high testability. USE FOR: defining port interfaces and adapter implementations, driving/driven adapters, technology-independent domain design, adapter-based testability, inversion of control at architectural boundaries DO NOT USE FOR: clean architecture layers specifically (use dev-craftsmanship-clean-architecture), microservice boundaries (use dev-architecture-microservices), domain model design (use dev-architecture-domain-driven-design)
---
