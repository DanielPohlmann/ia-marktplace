---
name: dev-frontend-ssr
description: Server-Side Rendering, Static Site Generation, Incremental Static Regeneration, Islands Architecture, Streaming SSR, and React Server Components. Covers Next.js, Nuxt, Remix, SvelteKit, and Astro in depth. In LinkDaily this applies to the Nuxt 3 public-facing site (frontend/public-nuxt). USE FOR: SSR, SSG, ISR, Islands Architecture, streaming SSR, React Server Components, Nuxt, Next.js, Remix, SvelteKit, Astro, choosing between SSR vs SSG vs ISR for SEO-critical or content-heavy pages DO NOT USE FOR: client-only SPAs (use dev-frontend-spa), progressive web apps (use dev-frontend-pwa), micro-frontend composition (use dev-frontend-micro-frontends)
---
