---
name: dev-design-patterns-behavioral
description: Use when implementing any of the 11 GoF Behavioral patterns (Chain of Responsibility, Command, Interpreter, Iterator, Mediator, Memento, Observer, State, Strategy, Template Method, Visitor). USE FOR: middleware/pipeline chains, command encapsulation, undo/redo, observer/publish-subscribe, algorithm strategy swapping, state machine modeling, iterator abstraction DO NOT USE FOR: object creation patterns (use dev-design-patterns-creational), structural composition patterns (use dev-design-patterns-structural), enterprise messaging (use dev-integration-patterns), pattern family selection (use dev-design-patterns)
---
