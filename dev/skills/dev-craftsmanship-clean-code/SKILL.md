---
name: dev-craftsmanship-clean-code
description: Use when writing or reviewing code for readability, maintainability, and expressiveness — based on Robert C. Martin's Clean Code. USE FOR: intention-revealing naming, function size and single-purpose design, comment quality, formatting standards, error handling strategy, code readability improvements across LinkDaily's Application and Domain layers. DO NOT USE FOR: architectural layer and dependency direction decisions (use dev-craftsmanship-clean-architecture), systematic code smell identification and refactoring techniques (use dev-craftsmanship-refactoring), SOLID principle evaluation (use dev-craftsmanship-solid).
---
...
- [Clean Code — Robert C. Martin (Book)](https://www.oreilly.com/library/view/clean-code-a/9780136083238/)
- [Robert C. Martin (Uncle Bob) — Clean Coder](https://blog.cleancoder.com/)
