---
name: dev-design-patterns-structural
description: Use when implementing any of the 7 GoF Structural patterns (Adapter, Bridge, Composite, Decorator, Facade, Flyweight, Proxy). USE FOR: adapting third-party interfaces, wrapping objects to add behavior dynamically, simplifying complex subsystems behind a facade, tree-structured composites, memory-efficient flyweights, access-control proxies DO NOT USE FOR: object creation and instantiation (use dev-design-patterns-creational), inter-object communication and algorithm encapsulation (use dev-design-patterns-behavioral), pattern family selection (use dev-design-patterns)
---
